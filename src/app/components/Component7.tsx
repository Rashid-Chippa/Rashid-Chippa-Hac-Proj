...
function Blogcards() {
  return (
    ...
    <><div className='text-center pb-0  '>
          ...
          <h1 className=' pt-9 font-great-vibes  text-[32px]  md:text-[32px]  text-custom-yellow '>Latest News & Blog</h1>
      ...
      <div className="card1 group border border-slate-300 pb-4 w-[250px] bg-black"> {/* Restricted width */}
  ...
  <div className="space-y-5 px-4">
    ...
    <div className="flex justify-between">
      ...
      <div className="flex justify-end items-center space-x-[5px] text-gray-400">
      ...
      <div className="card2 group border border-slate-300 pb-4 w-[250px] bg-black"> {/* Restricted width */}
  <div className="relative w-full rounded-md">
    <div className="flex justify-center items-center">
      <Image
        src="/images/piz.svg"
  ...
  <div className="space-y-5 px-4">
    ...
    <div className="flex justify-between">
      ...
      <div className="card3 group border border-slate-300 pb-4 w-[250px] bg-black"> {/* Restricted width */}
  <div className="relative w-full rounded-md text-gray-400">
    <div className="flex justify-center items-center">
      <Image
        src="/images/tac.svg"
        alt="Example Image"
